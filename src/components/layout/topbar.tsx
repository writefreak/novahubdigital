...
export function Topbar() {
  ...
  return (
    <>
      ...
      {/* Sticky Header Wrapper for both elements */}
      <div className="no-print sticky top-0 z-30 flex flex-col bg-white">
        {/* NovaHub Digital Header */}
        <div className="flex items-center md:hidden gap-2.5 px-4 pt-7 pb-2 md:px-8">
          <div>
        ...
        {/* Floating Profile & Greeting Bar */}
        <div className="flex items-center justify-center px-4 pb-4 pt-2 md:pt-7 md:px-8">
